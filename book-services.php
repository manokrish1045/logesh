...
<html lang="en">
<head>
<title>BIT E BOOKING PORTAL | Book Venues</title>
					...
					<div class="agileinfo-contact-form-grid">
						<form method="post">
							 <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4">Type of Venue:</label>
                                    <div class="col-md-10">
...
<option value="<?php echo htmlentities($row->EventType);?>"><?php echo htmlentities($row->EventType);?></option>
 <?php } ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4">Number of Capacity:</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" style="font-size: 20px" required="true" name="nop">
                                    </div>
                                </div>
                                                 <div class="form-group row">
                                    <label class="col-form-label col-md-4">Queries(if any)</label>
                                    <div class="col-md-10">
