...
<html lang="en">
<head>
<title>BIT E BOOKING PORTAL | Mail</title>
			...
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					<div class="w3layouts-contact-form-top">
						<h3>BEB - Support desk</h3>
						<p>Post your queries and request realted to  any of the activity ranging from register to booking confirmation and also provide feedback about our portal.</p>
					</div>
