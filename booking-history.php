...
<html lang="en">
<head>
<title>BIT E BOOKING PORTAL|| Booking History </title>
						...
						<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Booking ID</th>
                                        <th class="d-none d-sm-table-cell">Faculty Name</th>
                                        <th class="d-none d-sm-table-cell">Faculty ID</th>
                                        <th class="d-none d-sm-table-cell">Mail ID</th>
