...
<html lang="en">
<head>
<title>BIT E BOOKING PORTAL|| Home Page
</title>
				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							<h3>Book your slot easy and comfort</h3>
							<p>You can book your venue easy and more comfortable by specifying names and location of the venue under facilities.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							<h3>BOOK THE VENUE BASED ON THE EVENT</h3>
							<p>Book your venue based on the nature of the event(Regular Classes, Skills, Seminars, Labrotary activities etc,).</p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
